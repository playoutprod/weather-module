//Places api is use to handle location search and geoloc (algoliasearch)
//Time api is use to get localtime (timezonedb)
//Weather api is to get the datas (climacell)
